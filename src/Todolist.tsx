        ...
        <div className="App">
            <div>
                <h3>
                    ...
                    <IconButton aria-label="delete"> <Delete onClick={() => removeTodoList(props.todoListID)}/>
                    </IconButton>
                </h3>
                ...
                <div>
                    <Button variant={props.filterValue === 'All' ? "outlined" : "contained"} color="secondary"
                            size={'small'}
                            onClick={() => ChangeFilterHandler(props.todoListID, 'All')}>All</Button>
                    <Button variant={props.filterValue === 'Active' ? "outlined" : "contained"} color="success"
                            size={'small'}
                            onClick={() => ChangeFilterHandler(props.todoListID, 'Active')}>Active</Button>
                    <Button variant={props.filterValue === 'Completed' ? "outlined" : "contained"} color="error"
                            size={'small'}
